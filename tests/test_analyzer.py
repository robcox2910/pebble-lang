...
class TestForLoop:
    ...
    def test_range_four_args_rejected(self) -> None:
        ...
        with pytest.raises(
            ...
            analyze("for i in range(1, 2, 3, 4) {\n  print(i)\n}")
